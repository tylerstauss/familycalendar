  ...
  return (
    <div className="pb-4">
      ...
      <div className="max-w-2xl mx-auto px-4 md:px-8 py-6 space-y-6">
        ...
        <section className="bg-white rounded-2xl border border-gray-100 p-5">
          <h2 className="text-lg font-semibold text-gray-900 mb-1">Google Calendar Sync</h2>
          <p className="text-sm text-gray-400 mb-4">
            Events you create in this app will automatically sync to your Google Calendar.
          </p>
          {googleStatus === null ? (
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">{googleStatus.calendarName}</p>
                  <p className="text-xs text-gray-400">Syncing new events here</p>
                </div>
              </div>
              <button
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700"
            >
